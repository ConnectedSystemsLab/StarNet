...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default='../../data_global/data_osn/dataset_tp_sat.pkl',
...
def main():
    ...
    model = SatTimesNet(args.input_len, args.hidden_size, args.num_layers, args.output_len, feature_size, device,
